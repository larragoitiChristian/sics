...
$data['title'] = ":: Busca Beneficiario Seguro Popular";
$data['css'] = array(
    "jw/jqx.base.css",
    "jw/jqx.repss.css"
);
...
?>
    ...
    <h1 align="center">Buscar Beneficiario de Seguro Popular</h1>
    <p></p>
    ...
    <div class="ui container">
        <div class="row">
            <form id="form" method="GET" action="<?=base_url()?>index.php/buscaBeneficiario/buscarBeneficiarioSegPop">
            ...
            $tblDatos.jqxGrid(
                {
                    ...
                    columns: [
                        ...
                        { text: 'Folio Seguro Popular', datafield: 'FOLIO_SP_INTEGRANTE', width:200,cellsalign: 'center' }
                    ]
                });
        });
    </script>
